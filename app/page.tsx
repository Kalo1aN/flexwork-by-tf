    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-green-50 to-white">
        <div className="mx-auto max-w-6xl px-5 py-20 text-center sm:px-8 sm:py-28">
          <span className="inline-flex items-center gap-2 rounded-full border border-green-200 bg-white px-4 py-1.5 text-sm font-medium text-green-700">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl text-balance text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl md:text-6xl">
            30 минути интервю —{" "}
            <span className="text-green-600">после работиш кога искаш</span>
          </h1>
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/register"
              className="w-full rounded-xl border border-green-200 bg-white px-7 py-3.5 text-base font-semibold text-green-700 transition-colors hover:bg-green-50 sm:w-auto"
            >
              Стани изпълнител
            </Link>
          </div>
